...
export class IncidentHandoverCardComponent implements OnDestroy {
  ...
  statusColorClass = computed(() => {
    ...
    if (hours <= 0) return { border: 'border-gray-400', text: 'text-gray-500', bg: 'bg-gray-50' };
    if (hours < 1) return { border: 'border-red-500', text: 'text-red-600', bg: 'bg-red-50' };
    if (hours < 8) return { border: 'border-orange-500', text: 'text-orange-600', bg: 'bg-orange-50' };
    if (hours < 24) return { border: 'border-yellow-500', text: 'text-yellow-600', bg: 'bg-yellow-50' };
