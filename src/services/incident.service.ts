...
export class IncidentService {
  ...
  // The mock data has been moved into the signal's initial value.
      ...
      return [
        {
          ...
          assignedTo: 'Alice',
          createdDate: new Date(now.getTime() - 2 * 60 * 60 * 1000), // 2 hours ago
          slaBreachDate: new Date(now.getTime() + 30 * 60 * 1000),   // 30 minutes from now (Danger)
        ...
        },
        {
          ...
          priority: 'P1' as const,
          assignedTo: 'Bob',
          createdDate: new Date(now.getTime() - 5 * 60 * 60 * 1000), // 5 hours ago
          slaBreachDate: new Date(now.getTime() + 6 * 60 * 60 * 1000),  // 6 hours from now (Warning)
        ...
        },
        {
          ...
          assignedTo: 'Charlie',
          createdDate: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000), // 1 day ago
          slaBreachDate: new Date(now.getTime() + 18 * 60 * 60 * 1000), // 18 hours from now (Caution)
        ...
        },
        {
          ...
          assignedTo: 'Diana',
          createdDate: new Date(now.getTime() - 2 * 60 * 60 * 1000), // 2 hours ago
          slaBreachDate: new Date(now.getTime() + 2 * 24 * 60 * 60 * 1000), // 2 days from now (Safe)
        ...
        },
        {
          ...
          assignedTo: 'Eve',
          createdDate: new Date(now.getTime() - 3 * 24 * 60 * 60 * 1000), // 3 days ago
          slaBreachDate: new Date(now.getTime() + 5 * 24 * 60 * 60 * 1000), // 5 days from now (Safe)
        ...
        },
        {
          ...
          priority: 'P1' as const,
          assignedTo: 'Frank',
          createdDate: new Date(now.getTime() - 10 * 60 * 1000), // 10 minutes ago
          slaBreachDate: new Date(now.getTime() + 1 * 60 * 60 * 1000 + 15 * 60 * 1000), // 1 hour 15 minutes from now (Warning)
  ...
  constructor() {
    ...
    this.http.get<Incident[]>('/api/incidents').pipe(
      // The backend should return dates as ISO strings. We need to convert them to Date objects.
      tap(incidents => {
        const parsedIncidents = incidents.map(incident => ({
          ...incident,
          createdDate: new Date(incident.createdDate),
          slaBreachDate: new Date(incident.slaBreachDate),
        })).sort((a, b) => a.slaBreachDate.getTime() - b.slaBreachDate.getTime());
